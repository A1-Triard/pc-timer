...
const IRQ_0_HANDLER: &[u8] = &[
    ...
    0x00, // init (000Ch): db 0
    0x9C, //handler_entry (000Dh): pushf
    0x1E, // push ds
    0x53, // push bx
    0x50, // push ax
    0x8C, 0xC8, // mov ax, cs
    0x8E, 0xD8, // mov ds, ax
    0xC6, 0x06, 0x0C, 0x00, 0x01, // mov byte [init], 1
    ...
    0x73, 0x09, // jnc skip_bios_handler
    0x58, // pop ax
    0x5B, // pop bx
    0x1F, // pop ds
    0x9D, // popf
    0xEA, // jmp far ...
    0x00, 0x00, 0x00, 0x00, // bios_handler (003Ah): dd 0
